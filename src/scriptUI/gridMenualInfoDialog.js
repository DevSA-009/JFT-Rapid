...
const gridMenualInfoDialog = () => {
    try {
        ...
        const sizeList_array = objectKeys(CONFIG.Persist_Config.sizes[currentSizeContainer]["MENS"]).concat(objectKeys(CONFIG.Persist_Config.sizes[currentSizeContainer]["BABY"]));
        ...
        sizeContainerList.onChange = () => {
            ...
            const currentSizeList_array = objectKeys(CONFIG.Persist_Config.sizes[currentSizeVal]["MENS"]).concat(objectKeys(CONFIG.Persist_Config.sizes[currentSizeContainer]["BABY"]));
